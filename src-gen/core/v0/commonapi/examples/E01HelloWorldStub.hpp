...
public:
    ...
    typedef std::function<void (std::string _message)> sayByeReply_t;
    ...
    /// This is the method that will be called on remote calls on the method sayBye.
    virtual void sayBye(const std::shared_ptr<CommonAPI::ClientId> _client, std::string _name, sayByeReply_t _reply) = 0;
